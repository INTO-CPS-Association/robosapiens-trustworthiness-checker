...
fn binop_table(v1: Value, v2: Value, op: SBinOp) -> Value {
    ...
    match (v1, v2, op) {
        ...
        (Float(i1), Int(i2), NOp(iop)) => match iop {
            NumericalBinOp::Add => Float(i1 + i2 as f64),
            NumericalBinOp::Sub => Float(i1 - i2 as f64),
            NumericalBinOp::Mul => Float(i1 * i2 as f64),
            NumericalBinOp::Div => Float(i1 / i2 as f64),
            NumericalBinOp::Mod => Float(i1 % i2 as f64),
        },
        (Int(i1), Float(i2), NOp(iop)) => match iop {
            NumericalBinOp::Add => Float(i1 as f64 + i2),
            NumericalBinOp::Sub => Float(i1 as f64 - i2),
            NumericalBinOp::Mul => Float(i1 as f64 * i2),
            NumericalBinOp::Div => Float(i1 as f64 / i2),
            NumericalBinOp::Mod => Float(i1 as f64 % i2),
        },
        ...
        (Float(v1), Int(v2), COp(sop)) => match sop {
            CompBinOp::Eq => Bool(v1 == v2 as f64),
            CompBinOp::Le => Bool(v1 <= v2 as f64),
            CompBinOp::Lt => Bool(v1 < v2 as f64),
            CompBinOp::Ge => Bool(v1 >= v2 as f64),
            CompBinOp::Gt => Bool(v1 > v2 as f64),
        },
        (Int(v1), Float(v2), COp(sop)) => match sop {
            CompBinOp::Eq => Bool((v1 as f64) == v2),
            CompBinOp::Le => Bool((v1 as f64) <= v2),
            CompBinOp::Lt => Bool((v1 as f64) < v2),
            CompBinOp::Ge => Bool((v1 as f64) >= v2),
            CompBinOp::Gt => Bool((v1 as f64) > v2),
        },
