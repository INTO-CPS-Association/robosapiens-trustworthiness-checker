...
fn cast_to_type(expr: SExprTE, target: &StreamType) -> SExprTE {
    match target {
                    ...
                    Ok(te) => {
                        ...
                        match expected {
                            ...
                            None => {
                                ...
                                let inferred =
                                    gradual_fallback_type(extract_type(&final_te));
