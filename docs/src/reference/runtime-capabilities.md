...
| `async` | no |
| `dataflow` | no |
| `distributed` | not checked automatically (needs distribution settings) |
| `semi-sync` | no |
| `reconf-semi-sync` | not checked automatically (needs an input pipeline) |
| `reconf-dataflow` | not checked automatically (needs an input pipeline) |
